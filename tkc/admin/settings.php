...
if (isset($settings['contact_whatsapp'])) $contact_whatsapp = $settings['contact_whatsapp'];
if (isset($settings['contact_instagram'])) $contact_instagram = $settings['contact_instagram'];
if (isset($settings['contact_facebook'])) $contact_facebook = $settings['contact_facebook'];
if (isset($settings['weekday_start_time'])) $weekday_start_time = $settings['weekday_start_time'];
if (isset($settings['weekday_end_time'])) $weekday_end_time = $settings['weekday_end_time'];
if (isset($settings['weekend_start_time'])) $weekend_start_time = $settings['weekend_start_time'];
if (isset($settings['weekend_end_time'])) $weekend_end_time = $settings['weekend_end_time'];
if (isset($settings['holiday_start_time'])) $holiday_start_time = $settings['holiday_start_time'];
if (isset($settings['holiday_end_time'])) $holiday_end_time = $settings['holiday_end_time'];
if (isset($settings['payment_bank_transfer'])) $payment_bank_transfer = $settings['payment_bank_transfer'];
if (isset($settings['payment_bank_account'])) $payment_bank_account = $settings['payment_bank_account'];
if (isset($settings['payment_qris'])) $payment_qris = $settings['payment_qris'];
if (isset($settings['payment_qris_image'])) $payment_qris_image = $settings['payment_qris_image'];
if (isset($settings['payment_cash'])) $payment_cash = $settings['payment_cash'];
if (isset($settings['payment_confirmation_required'])) $payment_confirmation_required = $settings['payment_confirmation_required'];
if (isset($settings['maintenance_mode'])) $maintenance_mode = $settings['maintenance_mode'];
if (isset($settings['max_reservations_per_day'])) $max_reservations_per_day = $settings['max_reservations_per_day'];
